      ...
      <div className="mx-auto max-w-7xl px-6 py-16">
        ...
        <form onSubmit={onSubmit} className="mt-8 grid grid-cols-1 gap-6 md:grid-cols-3">
          <div className="md:col-span-2 space-y-6">
            <div className="border border-zinc-700 bg-zinc-900 p-4 rounded-xl shadow-md shadow-purple-900/20 transition-colors hover:border-mauve-700 hover:bg-zinc-800/60">
              <div className="text-zinc-50 text-xl font-semibold">Basic Information</div>
              <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div>
                  <label className="text-xs text-zinc-400">Title</label>
                  <input value={data.title} onChange={(e) => setData({ ...data, title: e.target.value })} className={`mt-1 w-full border px-3 py-2 text-sm rounded-md ${errors.title ? "border-red-600" : "border-zinc-700 bg-zinc-900 text-zinc-200"}`} placeholder="e.g., Neon Streets" />
                ...
                <div>
                  ...
                  <select value={data.category} onChange={(e) => setData({ ...data, category: e.target.value })} className={`mt-1 w-full border px-3 py-2 text-sm rounded-md ${errors.category ? "border-red-600" : "border-zinc-700 bg-zinc-900 text-zinc-200"}`}>
                ...
                <div>
                  ...
                  <div className="mt-1 flex items-center border border-zinc-700 bg-zinc-900 px-2 py-2 rounded-md">
                    ...
                    <button type="button" onClick={addTag} className="ml-2 border border-peach-700 px-2 py-1 text-xs text-peach-500 hover:bg-peach-600 hover:text-black rounded-md">Add</button>
                  </div>
                  {data.tags.length > 0 && (
                    <div className="mt-2 flex flex-wrap gap-2">
                      {data.tags.map((t) => (
                        <button key={t} type="button" onClick={() => removeTag(t)} className="inline-flex items-center gap-1 border border-zinc-700 bg-zinc-800/60 px-2 py-1 text-[11px] text-zinc-300 rounded-full hover:border-mauve-700 hover:text-mauve-600">
                ...
                <div className="sm:col-span-2">
                  ...
                  <textarea value={data.description} onChange={(e) => setData({ ...data, description: e.target.value })} rows={5} className={`mt-1 w-full border px-3 py-2 text-sm rounded-md ${errors.description ? "border-red-600" : "border-zinc-700 bg-zinc-900 text-zinc-200"}`} placeholder="Explain what your mod does, features, installation, etc." />
            ...
            <div className="border border-zinc-700 bg-zinc-900 p-4 rounded-xl shadow-md shadow-purple-900/20 transition-colors hover:border-mauve-700 hover:bg-zinc-800/60">
              ...
              <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div>
                  ...
                  <input type="file" accept="image/*" onChange={(e) => setData({ ...data, cover: e.target.files?.[0] })} className="mt-1 w-full border border-zinc-700 bg-zinc-900 px-3 py-2 text-sm text-zinc-200 rounded-md" />
                  {data.cover && (
                ...
                <div>
                  ...
                  <input
                    ...
                    className="mt-1 w-full border border-zinc-700 bg-zinc-900 px-3 py-2 text-sm text-zinc-200 rounded-md"
                  />
            ...
            <div className="border border-zinc-700 bg-zinc-900 p-4 rounded-xl shadow-md shadow-purple-900/20 transition-colors hover:border-mauve-700 hover:bg-zinc-800/60">
              ...
              <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div>
                  ...
                  <input value={data.version} onChange={(e) => setData({ ...data, version: e.target.value })} className={`mt-1 w-full border px-3 py-2 text-sm rounded-md ${errors.version ? "border-red-600" : "border-zinc-700 bg-zinc-900 text-zinc-200"}`} placeholder="e.g., 1.0.0" />
                ...
                <div className="sm:col-span-2">
                  ...
                  <textarea value={data.changelog} onChange={(e) => setData({ ...data, changelog: e.target.value })} rows={4} className="mt-1 w-full border border-zinc-700 bg-zinc-900 px-3 py-2 text-sm text-zinc-200 rounded-md" placeholder="Notes for this release" />
                </div>
              </div>
            </div>
            ...
            <div className="border border-zinc-700 bg-zinc-900 p-4 rounded-xl shadow-md shadow-purple-900/20 transition-colors hover:border-mauve-700 hover:bg-zinc-800/60">
              ...
              <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div className="sm:col-span-2">
                  ...
                  <input type="file" accept=".zip,.rar" onChange={(e) => setData({ ...data, modFile: e.target.files?.[0] })} className={`mt-1 w-full border px-3 py-2 text-sm rounded-md ${errors.modFile ? "border-red-600" : "border-zinc-700 bg-zinc-900 text-zinc-200"}`} />
          ...
          <aside className="space-y-6">
            <div className="border border-zinc-700 bg-zinc-900 p-4 rounded-xl shadow-md shadow-purple-900/20 transition-colors hover:border-mauve-700 hover:bg-zinc-800/60">
              ...
              <div className="mt-4 space-y-3">
                <div>
                  ...
                  <select value={data.license} onChange={(e) => setData({ ...data, license: e.target.value })} className="mt-1 w-full border border-zinc-700 bg-zinc-900 px-3 py-2 text-sm text-zinc-200 rounded-md">
                    {licenses.map((l) => (
                ...
                <div>
                  ...
                  <input value={data.homepage ?? ""} onChange={(e) => setData({ ...data, homepage: e.target.value })} className="mt-1 w-full border border-zinc-700 bg-zinc-900 px-3 py-2 text-sm text-zinc-200 rounded-md" placeholder="Optional URL" />
                </div>
                <div>
                  <label className="text-xs text-zinc-400">Source code</label>
                  <input value={data.sourceUrl ?? ""} onChange={(e) => setData({ ...data, sourceUrl: e.target.value })} className="mt-1 w-full border border-zinc-700 bg-zinc-900 px-3 py-2 text-sm text-zinc-200 rounded-md" placeholder="Optional URL" />
                </div>
              </div>
            </div>
            ...
            <div className="border border-zinc-700 bg-zinc-900 p-4 rounded-xl shadow-md shadow-purple-900/20 transition-colors hover:border-mauve-700 hover:bg-zinc-800/60">
              ...
              <div className="mt-4 space-y-3">
                <button type="submit" disabled={submitting} className={`w-full inline-flex items-center justify-center gap-2 px-3 py-2 text-sm ${submitting ? "bg-mauve-700" : "bg-mauve-600 hover:bg-mauve-500"} text-black rounded-md shadow-lg shadow-purple-900/20`}>
